...
this.amount = amount;
this.setPriority(priority); // calling setPriority()
}
public void run() {
System.out.println(getName() + " has priority: " + getPriority()); // calling getPriority()
...
public class PriorityBankDemo {
    public static void main(String[] args) {
        ...
        Customer c1 = new Customer(account, "Alice", 600, Thread.MAX_PRIORITY);   // 10
        Customer c2 = new Customer(account, "Bob", 400, Thread.NORM_PRIORITY);   // 5
        Customer c3 = new Customer(account, "Charlie", 300, Thread.MIN_PRIORITY); // 1
